...
var url = 'https://raw2.github.com/jlegewie/pdf.js/{0}/{1}',
 ...
 pdfExtract = [{
  ...
  {
    // introducted in zotfile version 2.0
    // get from zotfile code
    'version': '1',
    'name': 'extract v1', 
    'branch': 'extract-v1',
    'scripts': ['src/network.js', 'src/chunked_stream.js', 'src/pdf_manager.js', 'src/core.js', 'src/util.js', 'src/api.js', 'src/canvas.js', 'src/obj.js', 'src/function.js', 'src/charsets.js', 'src/cidmaps.js', 'src/colorspace.js', 'src/crypto.js', 'src/evaluator.js', 'src/fonts.js', 'src/glyphlist.js', 'src/image.js', 'src/metrics.js', 'src/parser.js', 'src/pattern.js', 'src/stream.js', 'src/worker.js', 'external/jpgjs/jpg.js', 'src/jpx.js', 'src/jbig2.js', 'https://raw2.github.com/jlegewie/pdf.js/809ed55841b0643892f7d6aac6999cca34f31db7/src/getPDFAnnotations.js'],
    'worker': 'src/worker_loader.js'    
  }*/];
            ...
            complete: function () {
                ...
                var getAnnos = function(i) {
                    ...
                    PDFJS.getPDFAnnotations(pdfs[i].file, true, progress, arg.debug).then(function(annos) {
                        ...
                        console.log(annos);
                        output.push(annos);
                        /*annos.annotations.forEach(function(anno){
                            console.log(anno.markup);
                        });*/
                        var distance = [];
...
// <div id="project1" class="colwrapper" style="width:800px;height:450;overflow:auto;"> </div>
                                });
